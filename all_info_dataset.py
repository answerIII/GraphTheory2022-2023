...
def get_info_dataset(data, q):
    ...
    if (len(edges_p_multi) > 4 * len(edges_n_multi)):
        edges_p_multi = random.sample(edges_p_multi, 4 * len(edges_n_multi))
    elif (len(edges_p_multi) * 4 < len(edges_n_multi)):
        edges_n_multi = random.sample(edges_n_multi, 4 * len(edges_p_multi))
